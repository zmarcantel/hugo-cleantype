...
STAGING=gh_dist
MASTER_CONTENTS="archetypes layouts static LICENSE.md README.md theme.toml .travis.yml"
...
git clone --branch master git@github.com:$PROJECT_OWNER/$PROJECT_NAME $STAGING
